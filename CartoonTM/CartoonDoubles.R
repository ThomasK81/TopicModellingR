...
base_corpus <- read.table("EQ-Cartoons-Doubles.csv", sep=",", header=TRUE)
...
#Visulise and start browser
serVis(json, out.dir = 'CartoonWDoublesCompsRemoved_vis', open.browser = FALSE)

## get the tables

dir.create("CartoonWDoublesCompsRemoved_tab")
...
colnames(phi.t.df) <- phicolnames
write.table(phi.t.df, file = 'CartoonWDoublesCompsRemoved_tab/phi.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)
...
thetacolnames[1] <- "identifier"
colnames(theta.frame) <- thetacolnames
write.table(theta.frame, file = 'CartoonWDoublesCompsRemoved_tab/theta.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)

total <- merge(base_corpus, theta.frame, by="identifier")


write.table(total, file = 'CartoonWDoublesCompsRemoved_tab/total.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)
...
write.table(fusionsave, file = 'CartoonWDoublesCompsRemoved_tab/fusionsave.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)

total_bydate$Date <- as.Date(total_bydate[,"Date"], "%d/%m/%Y")
CartoonWDoublesData <- total_bydate
saveRDS(CartoonWDoublesData, file="CartoonWDoublesData.Rda")