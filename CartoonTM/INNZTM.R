...
base_corpus <- read.table("IndexNZ_EQ-Sep-2010-Feb-2012.csv", sep=",", header=TRUE)
...
serVis(json, out.dir = 'INNZ_vis', open.browser = FALSE)
...
write.table(phi.t.df, file = 'INNZ_tab/phi.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)
...
write.table(theta.frame, file = 'INNZ_tab/theta.csv', append = FALSE, quote = FALSE, sep = ",", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE)
