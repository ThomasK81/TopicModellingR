setwd("~/OneDrive/GithubProjects/TopicModellingR/shiny/LatinTMApp")
...
ui <- fluidPage(
  ...
  #API request to fectch list of available Latin authors and their URNs
  
  titlePanel("Topic-Modelling based on CTS API Queries to the Perseus Digital Library"),
  
  sidebarLayout(
    sidebarPanel(
      selectInput("search_urn", label = "Latin Author", choices = list("Caesar" = 1, "Petronius" = 2), selected = 1),
